			...
			swatches: function (inst) {
				var that = this,
					...
					html = function () {
						...
						return '<div style="font-size: 0.7em; margin-bottom:4px;">'+ inst.options.swatchesTitle +':</div><div class="ui-colorpicker-swatches ui-colorpicker-border" style="width:' + inst.options.swatchesWidth + 'px">' + html + '</div>';
					};

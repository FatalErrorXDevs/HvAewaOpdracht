...
<spring:bind path="data">
    ...
    <form:textarea type="text" path="tempData[${DataIndex}].value" id="data-sel-${categoryIndex}-${tabIndex}-" items="${category.getData()}" itemLabel="name" itemValue="id" multiple="false" /> 

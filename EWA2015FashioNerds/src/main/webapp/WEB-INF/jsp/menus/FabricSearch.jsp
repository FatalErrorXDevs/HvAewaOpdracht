...
<div class="searchMenu">
    ...
    <ul class="side-menu">
        ...
        <ul>
            <li class="menu"><a href="${pageContext.request.contextPath}/Fabrics/"><spring:message code="menu.fabrics"/></a>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/Fabrics/Add/">+</a></li>
                </ul>
            </li>
        </ul>
    </li>
